export const repoSearchItemsResponse = {
  ...
  collaborators_url:
    "https://api.github.com/repos/huandu/facebook/collaborators{/collaborator}",
  teams_url: "https://api.github.com/repos/huandu/facebook/teams",
  hooks_url: "https://api.github.com/repos/huandu/facebook/hooks",
  issue_events_url:
    "https://api.github.com/repos/huandu/facebook/issues/events{/number}",
  events_url: "https://api.github.com/repos/huandu/facebook/events",
  assignees_url:
    "https://api.github.com/repos/huandu/facebook/assignees{/user}",
  branches_url:
    "https://api.github.com/repos/huandu/facebook/branches{/branch}",
  ...
  git_commits_url:
    "https://api.github.com/repos/huandu/facebook/git/commits{/sha}",
  comments_url:
    "https://api.github.com/repos/huandu/facebook/comments{/number}",
  issue_comment_url:
    "https://api.github.com/repos/huandu/facebook/issues/comments{/number}",
  contents_url: "https://api.github.com/repos/huandu/facebook/contents/{+path}",
  compare_url:
    "https://api.github.com/repos/huandu/facebook/compare/{base}...{head}",
  merges_url: "https://api.github.com/repos/huandu/facebook/merges",
  archive_url:
    "https://api.github.com/repos/huandu/facebook/{archive_format}{/ref}",
  ...
  milestones_url:
    "https://api.github.com/repos/huandu/facebook/milestones{/number}",
  notifications_url:
    "https://api.github.com/repos/huandu/facebook/notifications{?since,all,participating}",
...
export type RepoSearchItemsResponse = typeof repoSearchItemsResponse;
